  ...
  const projects = [
    {
      ...
      description: "An interactive learning platform where users learn programming concepts by building real projects with hands-on coding exercises and instant feedback.",
    ...
    },
    {
      ...
      description: "A platform where developers and creators can discover, share, and showcase their tech products including web apps, AI tools, software, games, and mobile applications.",
    ...
    },
    {
      ...
      description: "A platform connecting volunteers with organizations, featuring event management, scheduling, and real-time communication tools.",
    ...
    },
    {
      ...
      description: "A comprehensive platform for freelancers to manage projects, track time, invoice clients, and collaborate with team members efficiently.",
    ...
    {
      title: "Green Fork",
      description: "Sustainable food delivery platform connecting eco-conscious consumers with local restaurants that prioritize environmental responsibility.",
    ...
    },
    {
      ...
      description: "A digital platform connecting clients with legal professionals, featuring case management, document sharing, and virtual consultations.",
