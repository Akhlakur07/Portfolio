          ...
          {Object.entries(skills).map(([key, category], categoryIndex) => (
            ...
            >
              ...
              <div className="relative bg-gray-900/50 backdrop-blur-sm border border-gray-700/50 rounded-3xl p-8 h-full overflow-hidden">
                ...
                {/* Floating Icon */}
                <motion.div
                  className={`absolute -top-6 -right-6 w-24 h-24 bg-gradient-to-br ${category.color} rounded-2xl opacity-20 group-hover:opacity-30 transition-opacity duration-500 flex items-center justify-center`}
                  animate={{
                ...
                >
                  <category.icon className="w-10 h-10 text-white opacity-70" />
                </motion.div>
