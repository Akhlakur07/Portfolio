...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class MouseClass {
      ...
      init(container) {
        this.container = container;
        // Listen on window so cursor movements over foreground content still drive the background
      ...
      dispose() {
        ...
        window.removeEventListener("pointermove", this._onMouseMove, false);
      ...
      setCoords(x, y) {
        ...
        // Account for scroll position and fixed positioning
        const clientX = typeof x === "number" ? x : x.clientX;
        const clientY = typeof y === "number" ? y : x && x.clientY;
...
`;
    ...
    class ExternalForce extends ShaderPass {
      ...
      update(props) {
        const forceX = Mouse.diff.x * props.mouse_force; // Removed /2
        const forceY = Mouse.diff.y * props.mouse_force; // Removed /2

        const cursorSizeX = props.cursor_size * props.cellScale.x;
        const cursorSizeY = props.cursor_size * props.cellScale.y;

        // Use the mouse coordinates directly (already normalized)
