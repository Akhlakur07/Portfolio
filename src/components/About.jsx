...
const About = () => {
  ...
  return (
    <section
      id="about"
      ref={sectionRef}
      className="min-h-screen pb-10 px-6 relative overflow-hidden pt-20"
    >
      {/* Background Elements */}
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div ref={textRef} className="relative">
            <motion.div
            ...
            >
              <p>
                ...
                digital experiences that are not just functional but also
                visually captivating.
              </p>

              <p>
                My journey in web development started with curiosity and has
                evolved into a passion for building innovative solutions. I
                specialize in React ecosystem and enjoy pushing the boundaries
                of what's possible in the browser.
              </p>

              <p>
                When I'm not coding, you'll find me exploring new technologies,
                contributing to open-source projects, or designing
                unconventional user interfaces that challenge traditional web
                design norms.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="relative z-10 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-purple-300 font-medium">BRAC University</p>
